...
public class Main {
	...
	public static DaoSignalementMedia daoSignalementMedia = new DaoSignalementMedia();
	...
	public static void creer_medias() {
		...
		daoMedia.sauvegarder(new Media(true, daoUtilisateur.getUn(1),
				"Description1", false, null, "La terre est Ronde", visible,
				null));
		daoMedia.sauvegarder(new Media(true, daoUtilisateur.getUn(1),
				"Description2", false, null, "Thor HD", visible, null));
		daoMedia.sauvegarder(new Media(true, daoUtilisateur.getUn(2),
				"Description3", false, null, "Hulk", nonVisible, null));
		daoMedia.sauvegarder(new Media(true, daoUtilisateur.getUn(3),
				"Description4", false, null, "Titre", nonVisible, null));
		daoMedia.sauvegarder(new Media(true, daoUtilisateur.getUn(4),
				"Description5", false, null, "Youtube1", visible, null));
		daoMedia.sauvegarder(new Media(true, daoUtilisateur.getUn(5),
				"Description6", false, null, "Dailymotion", visible, null));
	}

	public static void creer_utilisateurs() {

		Utilisateur utilAdmin = new Utilisateur("admin@gmail.com", true,
				"admin", "password");
		utilAdmin.setNomUtilisateur("DreamTeam");
		utilAdmin.setEstAministrateur(true);
		daoUtilisateur.sauvegarder(utilAdmin);

		daoUtilisateur.sauvegarder(new Utilisateur(
				"Benjamin.Marzolf@gmail.com", false, "Benjamin", "password"));
		daoUtilisateur.sauvegarder(new Utilisateur("Jean@gmail.com", false,
				"Jean", "password"));
		daoUtilisateur.sauvegarder(new Utilisateur("Marc@gmail.com", false,
				"Marc", "password"));
		daoUtilisateur.sauvegarder(new Utilisateur("Luc@gmail.com", false,
				"Luc", "password"));
		daoUtilisateur.sauvegarder(new Utilisateur("Isabelle@gmail.com", false,
				"Isabelle", "password"));
		daoUtilisateur.sauvegarder(new Utilisateur("Louise@gmail.com", false,
				"Louise", "password"));

		Utilisateur utilBanni = new Utilisateur("Banni@gmail.com", true,
				"Banni", "password");
	...
	public static void creer_Playlist() {
		...
		daoPlaylist.sauvegarder(new Playlist("Ma playlist", "Musique de rock",
				"Description", daoTypePlaylist.typeAutre(), daoVisibilite
						.typeVisible()));
		daoPlaylist.sauvegarder(new Playlist("Mes favoris", "Favoris",
				"Description", daoTypePlaylist.typeFavoris(), daoVisibilite
						.typeVisible()));
		daoPlaylist.sauvegarder(new Playlist("En cours de lecture", "En cours",
				"Description", daoTypePlaylist.typeEnCours(), daoVisibilite
						.typeVisible()));
		daoPlaylist.sauvegarder(new Playlist("Ma playlist2", "Videos fun",
				"Description", daoTypePlaylist.typeAutre(), daoVisibilite
						.typeVisible()));
	}
	...
	public static void creer_Commentaire() {
		...
		daoCommentaire.sauvegarder(new Commentaire("Tous pourri -_-",
				daoUtilisateur.getUn(2)));
	}
	...
	public static void ajouter_objets_media() {
		...
		/*
		 * Tag tag1 = new Tag("Tag1"); Tag tag2 = new Tag("Tag2"); Tag tag3 =
		 * new Tag("Tag3"); Tag tag4 = new Tag("Tag4"); Tag tag5 = new
		 * Tag("Tag5"); Tag tag6 = new Tag("Tag6");
		 */
		daoMedia.getUn(1).getTags().add(new Tag("Tag1")); // NE PAS METTRE
															// tags_idTag en
															// PRIMARY KEY TODO
		...
		media.getCommentaires().add(
				new Commentaire("Bonjour!", daoUtilisateur.getUn(0)));
	...
	public static void ajouter_objets_utilisateur() {
		...
		util.getSignalementsUtilisateurs().add(
				new Signalement_Utilisateur("Pas gentil!", daoUtilisateur
						.getUn(4)));
		...
		util.getSignalementsMedias().add(
				new Signalement_Media("Pas conforme à la charte", daoMedia
						.getUn(3)));
		util.getNoteMedias().add(new Note(5, daoMedia.getUn(4)));
		util.getSignalementsCommentaires().add(
				new Signalement_Commentaire("Pas conforme a la charte !",
						daoCommentaire.getUn(1),daoUtilisateur.getUn(1)));
	...
	public static void main(String[] args) {
		...
		/*
		 * lister_utilisateurs(); lister_medias();
		 */

		DaoUtilisateur dao = new DaoUtilisateur();
		Utilisateur u = dao.getUn(3);
		Avatar a = new Avatar(
				"http://127.0.0.1:8080/MediArea/resources/avatar/8.png");
		u.setAvatar(a);
		dao.sauvegarder(u);
		...
		/*
		 * Utilisateur u = daoUtilisateur.getUn(1); Set<Amitie> set =
		 * u.getAmis(); for (Amitie a : set) {
		 * System.out.println(a.getAmi().getAdrMail()); }
		 * 
		 * System.out.println(set.isEmpty()); System.out.println(set.size());
		 */
		...
		Message_Prive mp1 = new Message_Prive("Bonjour, Cordialement", u1, u2,
				"Objet");
		Message_Prive mp2 = new Message_Prive("Bonjour, Cordialement", u1, u3,
				"Objet");
		Message_Prive mp3 = new Message_Prive("Bonjour, Cordialement", u1, u4,
				"Objet");
		Message_Prive mp4 = new Message_Prive("Bonjour, Cordialement", u1, u2,
				"Objet");
		Message_Prive mp5 = new Message_Prive("Bonjour, Cordialement", u1, u2,
				"Objet");

		Message_Prive mp6 = new Message_Prive("Bonjour, Cordialement", u2, u1,
				"Objet");
		Message_Prive mp7 = new Message_Prive("Bonjour, Cordialement", u2, u3,
				"Objet");
		Message_Prive mp8 = new Message_Prive("Bonjour, Cordialement", u2, u4,
				"Objet");

		Message_Prive mp9 = new Message_Prive("Bonjour, Cordialement", u3, u1,
				"Objet");
		Message_Prive mp10 = new Message_Prive("Bonjour, Cordialement", u3, u2,
				"Objet");
		Message_Prive mp11 = new Message_Prive("Bonjour, Cordialement", u3, u4,
				"Objet");
		...
		u = daoUtilisateur.getUn(3);
		u.getPlaylists().add(daoPlaylist.getUn(2));
